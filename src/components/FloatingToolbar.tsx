...
export const FloatingToolbar: React.FC<FloatingToolbarProps> = ({
  ...
  return (
    <nav className="floating-toolbar" aria-label="Quantum Chamber Controls">
      ...
      <div className="toolbar-pill-pair" role="group" aria-label="Wavefunction Display Quantity">
        <button
          type="button"
      ...
      <div className="toolbar-orbit-label" title="OrbitControls Active (Left-drag: Rotate, Right-drag: Pan, Wheel: Zoom)">
        <Compass size={12} />
        <span>ORBIT</span>
      </div>
